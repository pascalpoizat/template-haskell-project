...
- if you keep it for the badges, in the Readme file, `README.md` (there should be 4 instances), and also connect to the Travis CI, Coveralls, and Waffle sites to connect the repository of your project to them.
