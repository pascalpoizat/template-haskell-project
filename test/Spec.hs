...
uEq =
  testGroup "eq"
            ...
            ,(testCase "same x, different y" $
              ((Point 2 3) == (Point 2 5)) @?= False)
            ,(testCase "same y, different x" $
              ((Point 2 3) == (Point 4 3)) @?= False)
            ,(testCase "different x and y" $
